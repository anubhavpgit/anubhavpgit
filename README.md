...
- A (short MVP) C/C++ compiler for RISC-V, [Ferry](https://github.com/muttonbiryani69/ferry).
...
- Improvements in [Zuzu](https://github.com/muttonbiryani69/zuzu) - Imrpoving perfromance handling and added banner images support in the custom static site generator for my site ([anubhavp.dev](https://anubhavp.dev/))
- [Dough](https://github.com/muttonbiryani69/dough): a rich, modular, and customisable content generator written in Rust.
